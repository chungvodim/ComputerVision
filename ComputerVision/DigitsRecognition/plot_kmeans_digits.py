...
digits = load_digits()
print('raw digit data: ')
print(digits.data)
#Standardization of datasets
#Scaled data has zero mean and unit variance
data = scale(digits.data)
print('scaled digit data: ')
print(data)
...
def bench_k_means(estimator, name, data):
    ...
    #v_measure_score: The V-measure is the harmonic mean between homogeneity and completeness : v = 2 * (homogeneity * completeness) / (homogeneity + completeness)
